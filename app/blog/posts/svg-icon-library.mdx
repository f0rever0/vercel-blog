...
summary: "sopt-makers 디자인 시스템 구축 | svg icon 라이브러리"
---

## 서론

[sopt makers](https://makers.sopt.org/) 팀은 [SOPT 동아리](https://www.sopt.org/) 운영에 필요한 프로덕트를 만듭니다. SOPT 동아리에서 사용하는 여러 프로덕트 간 일관된 디자인과 효율적인 개발을 위해서 디자인 시스템의 필요성이 제기되었습니다.
...
icon 디자인 시스템을 개발하며 마주쳤던 고민들과 그 해결 과정을 정리해 보았습니다.
...
개발자, 디자이너의 원활한 작업과 소통을 위하여 icon 라이브러리 스토리북을 배포하였습니다.

![스크린샷 2024-10-14 오후 9.32.52.png](https://github.com/user-attachments/assets/860fdcc9-0613-48c5-b6c2-f685a9bb112d)
